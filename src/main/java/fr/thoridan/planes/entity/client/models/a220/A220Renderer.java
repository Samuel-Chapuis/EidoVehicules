...
public class A220Renderer extends PlaneRenderer<A220> {
    private static final ResourceLocation A220_TEXTURE = new ResourceLocation(ForPlanes.MOD_ID, "textures/entity/a220_texture.png");
    // This texture will be tinted with a custom color
    private static final ResourceLocation A220_COLORABLE_TEXTURE = new ResourceLocation(ForPlanes.MOD_ID, "textures/entity/a220_colorable_texture.png");
