...
public class RafaleModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition F15 = partdefinition.addOrReplaceChild("F15", CubeListBuilder.create(), PartPose.offset(0.0F, 26.0F, -12.0F));
		...
		PartDefinition cube_r22 = Vitre.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(60, 108).addBox(-6.5F, -7.0F, -1.5F, 6.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 0.0F, 1.1781F, 0.0F, 0.0F));

		PartDefinition cube_r23 = Vitre.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(60, 113).addBox(-6.5F, -6.0F, 0.5F, 6.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.15F, -21.0F, -1.0472F, 0.0F, 0.0F));

		PartDefinition cube_r24 = Vitre.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(60, 113).addBox(-6.5F, -7.0F, 0.5F, 6.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.75F, -14.1F, -1.5708F, 0.0F, 0.0F));
