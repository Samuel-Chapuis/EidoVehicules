package fr.Eidolyth.entity.vehicule.plane.declaration.models.tourist;

import fr.Eidolyth.entity.vehicule.plane.PlaneStructure;
import net.minecraft.world.entity.EntityType;
import net.minecraft.world.level.Level;

import static fr.Eidolyth.item.ModItems.YELLOW_PLANE_SPAWN_ITEM;
 ...
 */
public class ToursiticPlane extends PlaneStructure {
     ...
     */
    public ToursiticPlane(EntityType<? extends PlaneStructure> type, Level world) {
        super(type, world);
