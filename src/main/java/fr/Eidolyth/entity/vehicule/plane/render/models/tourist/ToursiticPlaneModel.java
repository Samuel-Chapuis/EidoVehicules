...
public class ToursiticPlaneModel<T extends Entity> extends HierarchicalModel<T> {
	private final ModelPart YellowPlane;
	private final ModelPart Pales;

	public ToursiticPlaneModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chaise = YellowPlane.addOrReplaceChild("Chaise", CubeListBuilder.create().texOffs(101, 185).addBox(-4.0F, 2.0F, -2.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(137, 176).addBox(-4.0F, -13.0F, 6.0F, 8.0F, 18.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(37, 177).addBox(-6.5F, -1.0F, -7.1F, 13.0F, 3.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -5.0F, -1.0F));

		PartDefinition Dossier_r1 = Chaise.addOrReplaceChild("Dossier_r1", CubeListBuilder.create().texOffs(2, 175).addBox(-2.0F, -15.0F, -1.0F, 12.0F, 18.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -2.0F, 4.0F, -0.2618F, 0.0F, 0.0F));
		...
		PartDefinition Cot_r1 = Chassis.addOrReplaceChild("Cot_r1", CubeListBuilder.create().texOffs(122, 30).addBox(8.0F, -5.0F, -1.0F, 1.0F, 8.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, -2.2F, 4.7F, -1.1606F, 0.0F, 0.0F));
		...
		PartDefinition Exterieur = Chassis.addOrReplaceChild("Exterieur", CubeListBuilder.create().texOffs(1, 77).addBox(0.0F, 7.0F, -32.0F, 9.0F, 3.0F, 30.0F, new CubeDeformation(0.0F))
				.texOffs(155, 109).addBox(7.9F, -2.0F, -28.0F, 1.0F, 9.0F, 29.0F, new CubeDeformation(0.0F))
		...
		PartDefinition ChassisArriere1_r1 = Exterieur.addOrReplaceChild("ChassisArriere1_r1", CubeListBuilder.create().texOffs(134, 137).addBox(10.0F, -17.0F, -1.0F, 2.0F, 24.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2597F, -0.0338F, -0.1265F));

		PartDefinition Portiere3_r1 = Exterieur.addOrReplaceChild("Portiere3_r1", CubeListBuilder.create().texOffs(179, 156).addBox(-0.5F, -4.5F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(164, 127).addBox(-0.5F, -4.5F, -11.0F, 1.0F, 7.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.3F, -2.5F, -5.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition Cockpit = Chassis.addOrReplaceChild("Cockpit", CubeListBuilder.create().texOffs(136, 71).addBox(0.0F, 4.0F, -32.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 36.0F));
		...
		PartDefinition Arriere_r1 = Cockpit.addOrReplaceChild("Arriere_r1", CubeListBuilder.create().texOffs(65, 30).addBox(0.0F, -18.0F, -1.0F, 9.0F, 26.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
		...
		PartDefinition Moteur_r1 = Nez.addOrReplaceChild("Moteur_r1", CubeListBuilder.create().texOffs(76, 144).addBox(-1.0F, -2.0F, -5.5F, 3.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.086F, -5.0213F, 5.6F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition Infill = Root.addOrReplaceChild("Infill", CubeListBuilder.create().texOffs(34, 110).addBox(2.8F, 5.0F, -10.0F, 4.0F, 12.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(87, 77).addBox(3.0F, 5.0F, -12.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(49, 143).addBox(2.9F, 10.0F, -14.0F, 4.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		...
		PartDefinition Exterieur2 = Chassis2.addOrReplaceChild("Exterieur2", CubeListBuilder.create().texOffs(1, 77).mirror().addBox(-5.0F, 7.0F, -32.0F, 9.0F, 3.0F, 30.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(114, 106).mirror().addBox(0.0F, -10.0F, 22.0F, 6.0F, 10.0F, 21.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(155, 109).mirror().addBox(-4.9F, -2.0F, -28.0F, 1.0F, 9.0F, 29.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 0.0F, 36.0F));

		PartDefinition Portiere1_r1 = Exterieur2.addOrReplaceChild("Portiere1_r1", CubeListBuilder.create().texOffs(164, 127).mirror().addBox(-0.5F, -4.5F, -11.0F, 1.0F, 7.0F, 19.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(179, 156).mirror().addBox(-0.5F, -4.5F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.3F, -2.5F, -5.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition QueuArriere3_r1 = Exterieur2.addOrReplaceChild("QueuArriere3_r1", CubeListBuilder.create().texOffs(123, 115).mirror().addBox(-5.0F, -5.0F, 11.0F, 5.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -5.0F, 19.0F, 0.0F, 0.2182F, 0.0F));

		PartDefinition QueuBasDetail_r2 = Exterieur2.addOrReplaceChild("QueuBasDetail_r2", CubeListBuilder.create().texOffs(65, 30).mirror().addBox(-9.0F, 2.0F, -1.0F, 9.0F, 3.0F, 37.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 5.0F, -3.0F, 0.2629F, 0.0832F, 0.0263F));

		PartDefinition QueuBas_r2 = Exterieur2.addOrReplaceChild("QueuBas_r2", CubeListBuilder.create().texOffs(77, 68).mirror().addBox(-12.0F, 3.0F, -1.0F, 10.0F, 4.0F, 34.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 2.0F, -3.0F, 0.265F, 0.1506F, 0.0446F));

		PartDefinition QueuHautPrincipale_r2 = Exterieur2.addOrReplaceChild("QueuHautPrincipale_r2", CubeListBuilder.create().texOffs(54, 106).mirror().addBox(-4.0F, -3.0F, -16.0F, 2.0F, 10.0F, 27.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1F, -8.8F, 22.0F, -0.2895F, 0.1607F, 0.0904F));

		PartDefinition QueuHaut_r2 = Exterieur2.addOrReplaceChild("QueuHaut_r2", CubeListBuilder.create().texOffs(10, 39).mirror().addBox(-9.0F, 3.0F, 5.0F, 9.0F, 2.0F, 35.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, -25.0F, -4.0F, -0.3043F, 0.0658F, -0.0242F));

		PartDefinition ChassisArriere2_r1 = Exterieur2.addOrReplaceChild("ChassisArriere2_r1", CubeListBuilder.create().texOffs(134, 137).mirror().addBox(-12.0F, -17.0F, -1.0F, 2.0F, 22.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, -0.2597F, 0.0338F, 0.1265F));
		...
		PartDefinition Moteur_r2 = Nez2.addOrReplaceChild("Moteur_r2", CubeListBuilder.create().texOffs(76, 144).mirror().addBox(-2.0F, -2.0F, -5.5F, 3.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.086F, -5.0213F, 5.7F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition Infill2 = Root2.addOrReplaceChild("Infill2", CubeListBuilder.create().texOffs(34, 110).mirror().addBox(-6.8F, 5.0F, -10.0F, 4.0F, 12.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(87, 77).mirror().addBox(-7.0F, 5.0F, -12.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(49, 143).mirror().addBox(-6.9F, 10.0F, -14.0F, 4.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(1, 77).mirror().addBox(-6.9F, 3.0F, -2.0F, 4.0F, 12.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false)
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		ToursiticPlane plane = (ToursiticPlane) entity;
